...
public class EngineGlobalScore {
  ...
  public static PlayerDataDTO setSellRecommendedActionDetails(PlayerDataDTO playerDataDTO) {
    ...
    if (playerDataDTO.getAveragePriceScore() == 1) {
      reccommendedActionDetails.append(
          "Jugador caro, el precion del jugador es más alto que el de la media por puntos en su posición. ");
    } else {
      reccommendedActionDetails.append(
          "Jugador barato, el precio del jugador es más bajo que el de la media por puntos en su posición.");
    }
    ...
    if (playerDataDTO.getAverageFitnessScore() == 1) {
      reccommendedActionDetails
          .append("El jugador está en un buen momento de forma. Mantener en alineación. ");
    } else {
